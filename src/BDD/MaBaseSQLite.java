...
public class MaBaseSQLite extends SQLiteOpenHelper {
	...
	+ COL_PSEUDO + " TEXT NOT NULL, " + COL_MDP + " TEXT NOT NULL, " + COL_REMEMBER + " TEXT, " + COL_MAIL + " TEXT, "
	+ COL_COMPTABLE + " INTEGER, " + COL_BANQUE + " INTEGER, " + COL_CATEGORIES + " TEXT," + COL_LIMIT_OPERATIONS + " TEXT);";
	...
	public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
		...
		//Lorsque je change la version les id repartent de 0
